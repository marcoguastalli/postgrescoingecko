...
- `setjdk21`
- `./mvnw clean package`
- `docker build --no-cache -t postgrescoingecko:v0.0.3 . -f Dockerfile_api`

### run image created from Dockerfile
- `docker run --rm --name postgrescoingecko -p 8080:8081 --network=v1_postgres-pgadmin postgrescoingecko:v0.0.3`

### access the image as root
- `docker run -it postgrescoingecko:v0.0.3 /bin/sh`
- `cat /etc/os-release`
